 ...
 */
public class Email_Register_Fragment extends BaseFragment implements Contract.ViewInf {
    @Override
    protected View initView() {
        View view = View.inflate(mActivity, R.layout.fragment_email_register, null);
        return view;
    }
